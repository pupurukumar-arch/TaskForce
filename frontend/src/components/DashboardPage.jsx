...
function ProjectCard({ project, role }) {
  const canManageProject = role === "admin";
    ...
    <article className="group flex min-h-60 flex-col rounded-2xl border border-slate-200/80 bg-[#fffdf9] p-6 shadow-sm shadow-slate-200/40 transition duration-200 hover:-translate-y-0.5 hover:border-indigo-200 hover:bg-indigo-50/40 hover:shadow-lg hover:shadow-indigo-100/60">
      ...
      <div className="mt-auto border-t border-slate-100 pt-5">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <Link to={`/projects/${project._id}/tasks`} className="rounded-lg bg-indigo-50 px-3 py-2.5 text-center text-xs font-semibold text-indigo-700 transition hover:bg-indigo-100 hover:text-indigo-800">
            Open project
          </Link>
          <Link to={`/projects/${project._id}/members?mode=view`} className="rounded-lg bg-indigo-50 px-3 py-2.5 text-center text-xs font-semibold text-indigo-700 transition hover:bg-indigo-100 hover:text-indigo-800">
            Members
          </Link>
          {canManageProject && (
            <Link to={`/projects/${project._id}/settings`} className="rounded-lg bg-indigo-50 px-3 py-2.5 text-center text-xs font-semibold text-indigo-700 transition hover:bg-indigo-100 hover:text-indigo-800 sm:col-span-2">
              Settings
            </Link>
          )}
        </div>
